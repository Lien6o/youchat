...
public class Lock<K, V> {
     ...
     * @return
     */
    public V ctreateLockAndGetLock(String lockName, int acquireTime, LockCallBack<K, V> lockCallBack) {
...
//        }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // });
        // Thread.sleep(1000);
        String ctreateLockAndGetLock = openLock.ctreateLockAndGetLock("lock_name", 2, new LockCallBack<String, String>() {
